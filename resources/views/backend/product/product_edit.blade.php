                            ...
                            <div class="row g-3">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select name="brand_id" class="form-select" id="inputProductType">
                                        ...
                                        <option value="{{ $brand->id }}" {{ data_get($brand, 'id') == data_get($products, 'brand_id') ? 'selected' : '' }}>{{ $brand->brand_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-12">
                                    ...
                                    <select name="category_id" class="form-select" id="inputVendor">
                                        ...
                                        <option value="{{ $cat->id }}" {{ data_get($cat, 'id') == data_get($products, 'category_id') ? 'selected' : '' }}>{{ $cat->category_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-12">
                                    ...
                                    <select name="subcategory_id" class="form-select" id="inputCollection">
                                        ...
                                        <option value="{{ $subcat->id }}" {{ data_get($subcat, 'id') == data_get($products, 'subcategory_id') ? 'selected' : '' }}>{{ $subcat->subcategory_name }}</option>
                                        @endforeach
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="vendor_id" class="form-select" id="inputCollection">
                                        ...
                                        <option value="{{ $vendor->id }}" {{ data_get($vendor, 'id') == data_get($products, 'vendor_id') ? 'selected' : '' }}>{{ $vendor->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault" {{ data_get($products, 'hot_deals') == 1 ? 'checked' : '' }}>Hot Deals</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault" {{ data_get($products, 'featured') == 1 ? 'checked' : '' }}>Featured</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault" {{ data_get($products, 'special_offer') == 1 ? 'checked' : '' }}>Special Offer</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault" {{ data_get($products, 'special_deals') == 1 ? 'checked' : '' }}>Special Deals</label>
                                            </div>
                                        </div>
